        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="card-title cursor-pointer text-primary ">Nest Shaped Chair</h6>
                        <div class="clearfix">
                            <p class="mb-0 float-start text-danger"><strong>134</strong> Sales</p>
                            <p class="mb-0 float-end fw-bold text-success"><span class="me-2 text-decoration-line-through">$350</span><span class="text-white">$240</span></p>
                        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="card-title cursor-pointer text-warning">Nest Shaped Chair</h6>
                        <div class="clearfix">
                            <p class="mb-0 float-start text-muted"><strong>134</strong> Sales</p>
